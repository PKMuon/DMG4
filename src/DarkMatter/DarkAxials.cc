...
double TotCSAxialParticle(double MAtest) // CS in GeV^-2 for masses below 1 MeV for epsilon=1
{
  ...
  double TotCSList[nMALowM] = {39009285714.,390765781.,98066229.,43807779.,24790270.,15972196.,11172093.,8270899.,1928757.,4153578.,1134564.,550112.,335527.,231262.,171841.,134298.,108807.,90558.2};
