...
// NB HERE!!!! Misha I collect below modifications

  // Coefficients in amplitude for Vector
  /*
...
// Coefficients in amplitude for Scalar
/*
...
// Coefficients in amplitude for Pseudo Scalar
  double JZ   =  XEv2 / (1.0 - XEv)
       , K    = 2.0 * MA2 * XEv
...
*/
 ...
 // This is for Pseudo Scalar Case
...
// NB!!! Misha I collect below vector and scalar factors for the  hidden boson

  //double Factor1= 2.0*(2.0-2.0*XEv+x2)/(1.0-XEv); // <- For vector case of hidden boson
  //double Factor2= 4.0*(MA2+2.0*Mmu2)/utilde2; // <- For vector case of hidden boson
  //double Factor3= utilde*XEv+MA2*(1.0-XEv)+Mmu2*x2; // <- For vector case of hidden boson

 // double Factor1= x2/(1.0-XEv); // <- For scalar case of hidden boson
 //  double Factor2=2.0*(MA2-4.0*Mmu2)/utilde2; // <- For scalar case of hidden boson
 //  double Factor3= utilde*XEv+MA2*(1.0-XEv)+Mmu2*x2; // <- For pseudo-scalar case of hidden boson


   double Factor1= x2/(1.0-XEv); // <- For pseudo-scalar case of hidden boson
   double Factor2=2.0*MA2/utilde2; // <- For pseudo-scalar case of hidden boson
   double Factor3= utilde*XEv+MA2*(1.0-XEv)+Mmu2*x2; // <- For pseudo-scalar case of hidden boson
