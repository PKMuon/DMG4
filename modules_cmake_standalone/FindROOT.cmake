...
if(ROOT_FOUND)
  if(NOT ROOT_VERSION_STRING)
    ...
    STRING(REGEX REPLACE "^([0-9]+)\\.[0-9][0-9]+[\\/\\.][0-9][0-9]+.*" "\\1" found_root_major_vers "${ROOT_VERSION_STRING}")
    STRING(REGEX REPLACE "^[0-9]+\\.([0-9][0-9])+[\\/\\.][0-9][0-9]+.*" "\\1" found_root_minor_vers "${ROOT_VERSION_STRING}")
    STRING(REGEX REPLACE "^[0-9]+\\.[0-9][0-9]+[\\/\\.]([0-9][0-9]+).*" "\\1" found_root_patch_vers "${ROOT_VERSION_STRING}")
    ...
    set(ROOT_VERSION_MAJOR ${found_root_major_vers} CACHE INTERNAL "Major version of ROOT")
    set(ROOT_VERSION_MINOR ${found_root_minor_vers} CACHE INTERNAL "Minor version of ROOT")
    set(ROOT_VERSION_PATCH ${found_root_patch_vers} CACHE INTERNAL "Patch version of ROOT")
  endif()
