...
flags.append('-I' + os.path.join(dirname_org, 'include', 'DMG4'))
flags.append('-I' + os.path.join(dirname_org, 'include', 'DMG4', 'DMParticles'))
flags.append('-I' + os.path.join(dirname_org, 'include', 'DMG4', 'DMProcesses'))
